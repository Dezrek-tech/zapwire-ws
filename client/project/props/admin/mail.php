...
<div class="container">
    <div class="row">
        ...
        <div class="card">
                ...
                <form class="card-body" action="amvc.api" api-key="admin/mail.php" callback="formHandler" method="post" async="true">
                    <div class="form-group">
                        <label for="exampleFormControlInput1">From</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" name="from">
                    </div>
                    <!-- subject -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="user_ids" name="user_ids">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <button class="btn btn-success" id="reply">Mail</button>
                            </div>
                        </div>
                    </div>
                </form>
