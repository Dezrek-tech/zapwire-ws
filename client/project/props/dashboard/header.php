    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="<?=$app->url("/dashboard")?>" class="app-brand-link">
        ...
        <li class="menu-header small text-uppercase"><span class="menu-header-text">Dashboard</span></li>
          ...
          <li class="menu-item <?= $_data['current_page'] == '' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/') ?>" class="menu-link">
          ...
          <li class="menu-item <?= $_data['current_page'] == 'msgs' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/messages') ?>" class="menu-link">
          ...
          <li class="menu-item <?= $_data['current_page'] == 'rprt' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/report') ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-bell"></i>
          ...
          <li class="menu-item <?= $_data['current_page'] == 'channels' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/channels') ?>" class="menu-link">
          ...
          <li class="menu-item <?= $_data['current_page'] == 'create_channel' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/channels/create') ?>" class="menu-link">
          ...
          <li class="menu-item <?= $_data['current_page'] == 'gen_w_code' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/channels/gen') ?>" class="menu-link">
          ...
          <li class="menu-item <?= $_data['current_page'] == 'ch_logs' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/channels/logs') ?>" class="menu-link">
          ...
          <li class="menu-item <?= $_data['current_page'] == 'settings' ? 'active' : '' ?>">
            <a href="<?= $app->url('dashboard/settings') ?>" class="menu-link">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <?php foreach($report->get_unread_messages() as $current_message): ?>
                    <li class="nav-link"><a href="<?=$app->url("dashboard/messages?m_id={$current_message['id']}")?>" class="nav-item dropdown-item"><?=$current_message['subject']?></a></li>
                  <?php endforeach; ?>
                  <?php
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <!-- darkmode switch -->
                  <li>
                    <a class="dropdown-item darkmode-switch" href="javascript:void(0)" id="darkmode-switch">
                  ...
                  <li>
                    <a class="dropdown-item" href="<?=$app->url("settings")?>">
                  ...
                  <li>
                    <a class="dropdown-item" href="<?=$app->url("logout")?>">
