<?php
    class Report {
        ...
        function get_reports () {
            ...
            $arr = array();
            while($row = mysqli_fetch_assoc($get_reports_query)) {
                $arr[] = $row;
            }

            $get_reports_query = $arr;
        ...
        function get_report ($id) {
            ...
            $get_report_query = mysqli_fetch_assoc($get_report_query);
            
            if ($get_report_query) {
                return $get_report_query;
            } else {
                return false;
            }
        }
        ...
        function get_unread_reports_count () {
            ...
            $get_reports_query = mysqli_fetch_array($get_reports_query, MYSQLI_ASSOC);
